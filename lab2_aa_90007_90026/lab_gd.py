...
###Quad1
def quad1(x_o=-9.0,a=5.0,eta=1.0,threshold=0.01,maxiter=1000,anim=0):
    it = 0
...
#%%
###Quad2
def quad2(x_o=[-9.0,9.0],a=1.0,eta=1,threshold=0.01,maxiter=1000,alpha=0,anim=0):
    it = 0
...
x_min = quad2(a=20.0,eta=3.9,anim = 0,alpha=0.95)
print('The estimated value is %s' %(x_min))
...
x_min = rosen(x_o=[-1.5,1.0],a=20,eta=0.0121,threshold=.001,maxiter=1000,alpha=0.99,anim = 0,up = 1.1,down = 0.9,reduce = 0.5)
print('The estimated value is %s' %(x_min))